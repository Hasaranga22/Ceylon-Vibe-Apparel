...
<div class="mainSectionTerms">
    <h4>OVERVIEW</h4>
    <p>
        This website <strong>tshirtrepublic.lk</strong> is operated by Arora Connect (Pvt) Limited. Throughout the site,
        the
        terms “we”, “us” and “our” refer to Arora Connect (Pvt) Limited; Arora Connect (Pvt) Limited offers this
        website,
    ...
    <p>
        ...
        the
        following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and conditions
        and
    ...
    <p>
        ...
        part
        of the site, you agree to be bound by these Terms of Service. If you do not agree to all the terms and
        conditions of
        this agreement, then you may not access the website or use any services. If these Terms of Service are
        considered an
    ...
    <p>
        Our store is hosted on WooCommerce. They provide us with the online e-commerce platform that allows us to sell
        our
    ...
    <p>
        ...
        material
        on this site is provided for general information only and should not be relied upon or used as the sole basis
        for
    ...
    <p>
        ...
        may
        have limited quantities and are subject to return or exchange only according to our Return Policy. Please review
        our
        Returns & Exchanges for more details.
    </p>
    ...
    <p>
        ...
        limit
        the quantities of any products or services that we offer. All descriptions of products or product pricing are
    ...
    <p>
        For more detail, please review our Returns & Exchanges.
    </p>
    ...
    <p>
        ...
        or
        any other transactions made in connection with any third-party websites. Please review carefully the
        third-party’s
    ...
    <p>
        ...
        shall
        be under no obligation (1) to maintain any comments in confidence; (2) to pay compensation for any comments; or
        (3)
    ...
    <p>
        ...
        privacy,
        personality or other personal or proprietary right. You further agree that your comments will not contain
        libelous
        or otherwise unlawful, abusive or obscene material, or contain any computer virus or other malware that could in
        any
        way affect the operation of the Service or any related website. You may not use a false e-mail address, pretend
        to
        be someone other than yourself, or otherwise mislead us or third-parties as to the origin of any comments. You
        are
